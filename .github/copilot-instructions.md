...
- When rendering categories or other manual-pick option lists in admin/editor UIs, sort them alphabetically using Swedish collation unless there is an explicit product reason to preserve a custom business order.
