...
const BATCH_SIZE = 50;
const PAGE_SIZE = 200;
const OUTPUT_PATH = "exports/ai-categories-batch-001.json";
...
async function main() {
  ...
  const payload = {
    ...
    totalActiveLots: totalMatchingLots,
  ...
  console.log(JSON.stringify({ outputPath: OUTPUT_PATH, exportedLots: collected.length, totalActiveLots: totalMatchingLots, activeLotsScanned: offset }, null, 2));
}
